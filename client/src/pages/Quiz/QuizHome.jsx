...
function QuizHome() {
  ...
  const QUICK = ["Data Structures","Operating Systems","Computer Networks","DBMS","OOP Concepts","JavaScript"];
  ...
  const generate = () => {
    ...
    navigate("/quiz/view", { state: { topic: topic.trim() } });
  };
          ...
          <div style={S.layout}>
            <div style={S.mainCard}>
                ...
                {file ? (
                  <div style={S.filePreview}>
                    ...
                    <div style={{flex:1}}>
                      ...
                      <p style={S.fileOk}>✅ Quiz will be generated from this file</p>
                    </div>
              ...
              <div style={S.inputGroup}>
                ...
                <input placeholder="e.g. Data Structures, DBMS, JavaScript..." value={topic}
              ...
              <div style={S.inputGroup}>
                ...
                <div style={{display:"flex",gap:10}}>
                  {[5,10,15].map(n=>(
                    <button key={n} style={{...S.countBtn,...(count===n?S.countActive:{})}} onClick={()=>setCount(n)}>
                      {n} Questions
                    </button>
                  ))}
                </div>
...
const S = {
  ...
  countBtn:{padding:"9px 18px",borderRadius:8,border:"1px solid rgba(255,255,255,0.08)",background:"rgba(255,255,255,0.04)",color:"#64748b",fontSize:13,fontWeight:700,cursor:"pointer",transition:"all 0.2s"},
